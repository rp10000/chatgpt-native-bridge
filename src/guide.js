...
5. If ChatGPT is selected but no reply appears, run or ask me to run npx github:rp10000/chatgpt-native-bridge mcp wait to confirm whether ChatGPT actually called MCP.
