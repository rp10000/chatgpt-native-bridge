...
普通 Windows 用户优先下载安装包：

[下载最新版 Windows 安装包](https://github.com/rp10000/chatgpt-native-bridge/releases/latest)

如果你想用 CLI，在你要处理的项目目录里运行：

```bash
npx --yes chatgpt-native-bridge start
```

如果 npm 暂时不可用，可以用 GitHub 备用命令：
