...
- 第一次：让 Codex 运行 `npx github:rp10000/chatgpt-native-bridge setup --mcp`
...
- GitHub 仓库已公开。
- npm registry 可能还没有发布，发布前请用 `npx github:rp10000/chatgpt-native-bridge setup --mcp` 或 `npm link`。
